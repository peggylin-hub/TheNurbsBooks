...
$$z(u,v) \= \\cos(u)$$ 		$$0 \\leq u \\leq \\pi,\\quad 0 \\leq v \\leq 2\\pi$$			(1.3)
...
$$\\mathbf{N} \= \\frac{\\mathbf{S}\_u \\times \\mathbf{S}\_v}{|\\mathbf{S}\_u \\times \\mathbf{S}\_v|}$$				(1.4)
